    ...
    return (
      <div className="bg-gradient-to-r from-red-700 via-red-600 to-red-500 text-white py-4 px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center fixed top-0 left-0 w-full z-50 shadow-md">
        ...
        >
          ...
          />
          <span className="text-xl sm:text-2xl font-semibold">One Piece NFTs</span>
        </div>
        
        {/* Navigation Links and Wallet Button */}
        <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
          <Link href="/marketplace" className="font-semibold hover:underline text-center">
            Marketplace
          </Link>
          <Link href="/my-nfts" className="font-semibold hover:underline text-center">
            My NFTs
          </Link>
          {isOwner && (
            <Link href="/mint" className="font-semibold hover:underline text-center">
              Mint NFTs
            </Link>
          )}
          <WalletButton />
